...
urlpatterns = [
    ...
    path('api/teams/<int:team_id>/', views.get_team),
    ...
    path('api/events/teams/<int:team_id>/results/', views.resultadosEquipos),
    path('api/matches/', views.MatchList.as_view()),
    path('api/matches/<int:match_id>/', views.get_match),
    ...
    path('api/players/<int:player_id>/', views.get_player),
